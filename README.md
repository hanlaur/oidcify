...
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | -------- |
| `issuer`                   | OIDC Issuer URL. Will be used to formulate the URL for OIDC discovery document. Example: `https://oidc.issuer.internal/`                                                                                 |                          | x        |
| `client_id`                | OIDC Client ID for OIDC Authorization Code Flow.                                                                                                                                                         |                          | x        |
| `client_secret`            | OIDC Client Secret.                                                                                                                                                                                      |                          | x        |
| `redirect_uri`             | OIDC redirect URI. For example `https://myserver.internal/cb`                                                                                                                                            |                          | x        |
| `consumer_name`            | Defines the Kong Consumer that will be set as authenticated consumer for a successful request.                                                                                                           |                          | x        |
